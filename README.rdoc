...
There's a [bug in Rails 4.1.0.beta1](https://github.com/rails/rails/issues/13372) that
breaks default_url_options from being picked up properly in email templates.

This issue is currently breaking both sending and previewing emails.

There's also a new way to intercept mail previews using Premailer that looks like
