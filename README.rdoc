...
```bash
git clone https://github.com/starterkit/rails4-starterkit.git
...
1. Replace `StarterKit` and `starterkit` with your app name in...
...
```bash
git remote add upstream https://github.com/starterkit/rails4-starterkit.git
